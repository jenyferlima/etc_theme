<form action="webinar-send.php" method="post">
  <div class="row">
    ...
    <div class="col-12 col-lg-6">
      <div class="form-group">
        <label for="form-fname"><p>Nome*</p></label>
    ...
    <div class="col-12 col-lg-6">
      <div class="form-group">
        <label for="form-lname"><p>Sobrenome*</p></label>
  ...
  <div class="row">
    ...
    <div class="col-12 col-lg-6">
      <div class="form-group">
        <label for="form-profile"><p>Perfil*</p></label>
        <select class="form-control" id="form-profile" name="form-profile" required>
          <option selected></option>
    ...
    <div class="col-12 col-lg-6">
      <div class="form-group">
        <label for="form-area"><p>Área de Estudo*</p></label>
        <select class="form-control" id="form-area" name="form-area" required>
          <option selected></option>
    ...
    <div class="col-12">
      <div class="form-group">
        <label for="form-instituicao"><p>Nome da Instituição Educacional</p></label>
        <input type="text" class="form-control" id="form-instituicao" name="form-instituicao">
      </div>
    </div>
  </div>
