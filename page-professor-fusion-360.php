          ...
          <div class="collapse" id="collapseExample" style="background: #fff; padding: 15px; border-radius: 5px;">
              ...
              <div class="row">
                <div class="col-12 col-lg-12">
                  <p>Professor, você precisa do seu <b>ID</b>.</p>
                  <div class="row justify-content-center">
                    <div class="col-8 col-lg-8"><input type="text" value="AM1017554846" readonly  id="myInput" class="form-control" style="padding: 3px 10px; margin-bottom: 10px; font-size:12px; font-weight:600; text-align:center;"></div>
                    <div class="col-1 col-lg-1" style="padding:0px"><i class="far fa-copy" onclick="myFunction()" style="cursor:pointer"></i></div>
                  </div>
